...
class _ChatGPTSheetComponentState extends State<ChatGPTSheetComponent> {
  ...
  Widget build(BuildContext context) {
    return Container(
      height: context.getScreenHeight * 0.96,
      margin: EdgeInsets.only(top: context.getScreenHeight * 0.04),
                ...
                isLoading
                    ? Center(
                        child: widget.loaderWidget ??
                            Container(
                              width: context.getScreenWidth * 0.35,
                              height: 37,
                            ...
                            if (isTextAnimationCompleted)
                              IconButton(
                                onPressed: () {
                                  ...
                                  goBack(context, answerCont.text);
                                },
                ...
                if (widget.recentList.isNotEmpty &&
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        height: context.getScreenHeight * 0.42,
                        child: AnimatedListView(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              onTap: () {
                                goBack(context, widget.recentList[index]);
                              },
